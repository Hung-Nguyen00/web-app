            ...
            <div class="col-12">
                ...
                <div class="col-12 d-flex justify-content-between">
                    @foreach($vouchers as $voucher)
                        ...
                        <div class="col-3 btn btn-info mt-3 d-flex align-items-center justify-content-center">

                            <h4 class="text-light pt-2" style="font-size: 15px"> {{ $voucher->code}}</h4>
                        </div>
                        @else
                            <div class="col-3 btn btn-danger mt-3 d-flex align-items-center justify-content-center">
